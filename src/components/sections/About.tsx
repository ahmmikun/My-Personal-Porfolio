...
export function About() {
  return (
    <section id="About" className="relative py-24 min-h-screen flex items-center bg-cyber-black z-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        ...
        <div className="mb-20">
          ...
          >
            ...
            <div className="glow-line h-[1px] w-32" />
          </motion.div>
          <motion.h2 
        ...
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-20">
          ...
          >
            {/* Bio Card */}
            <CyberPanel3D className="p-8 md:p-10 bg-cyber-surface border border-cyber-border relative overflow-hidden group hover:border-cyber-yellow/40 transition-colors duration-500 rounded-sm">
              ...
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-2xl md:text-3xl font-orbitron font-bold text-cyber-white">
              ...
              {/* Fact Counters */}
              <div className="grid grid-cols-3 gap-6 border-t border-cyber-border pt-8 mt-10">
                ...
                <div className="text-center border-l border-cyber-border group/stat">
                  ...
                  <div className="text-xs tracking-widest text-cyber-gray uppercase font-bold">Hours</div>
                </div>
              </div>
            </CyberPanel3D>
          </motion.div>
          ...
          >
              ...
              <div className="relative flex items-start gap-8 group">
                  ...
                  <div className="flex-1 pb-4 border-b border-cyber-border group-hover:border-cyber-green/30 transition-colors">
                    ...
                    <div className="flex gap-2 text-cyber-gray">
                      ...
                      <SiNextdotjs className="w-4 h-4 hover:text-cyber-white transition-colors" title="Next.js" />
              ...
              <div className="relative flex items-start gap-8 group">
                  ...
                  <div className="flex-1 pb-4 group-hover:border-cyber-yellow/30 transition-colors">
                    <div className="flex flex-col mb-1">
                        ...
                        <h4 className="font-bold text-cyber-white text-base sm:text-lg leading-tight group-hover:text-cyber-yellow transition-colors">Open Source Contributor</h4>
                    </div>
                    <p className="text-xs sm:text-sm text-cyber-gray mb-3">Global / Remote</p>
            ...
            {/* Education Section */}
            <h3 className="text-lg font-orbitron text-cyber-white mt-12 mb-10 uppercase tracking-widest flex items-center gap-4">
              <span className="w-3 h-3 bg-cyber-gray rotate-45 shadow-[0_0_8px_rgba(148,163,184,0.4)]" /> 
              Education
            </h3>
            
            <div className="space-y-10 relative before:absolute before:inset-0 before:ml-[1.4rem] before:-translate-x-px before:h-full before:w-[2px] before:bg-gradient-to-b before:from-cyber-border before:via-cyber-border before:to-transparent">
              ...
              <div className="relative flex items-start gap-8 group">
                  ...
                  <div className="flex-1 pb-4 border-b border-cyber-border group-hover:border-cyber-yellow/30 transition-colors">
                    <div className="flex flex-col mb-1">
                        ...
                        <h4 className="font-bold text-cyber-white text-base sm:text-lg leading-tight group-hover:text-cyber-yellow transition-colors">BSCS</h4>
                    </div>
                    <p className="text-xs sm:text-sm text-cyber-gray">Punjab University</p>
                  </div>
              </div>
              ...
              <div className="relative flex items-start gap-8 group">
                  ...
                  <div className="flex-1 pb-4 group-hover:border-cyber-yellow/30 transition-colors">
                    <div className="flex flex-col mb-1">
                        ...
                        <h4 className="font-bold text-cyber-white text-base sm:text-lg leading-tight group-hover:text-cyber-yellow transition-colors">HSSC</h4>
                    </div>
                    <p className="text-xs sm:text-sm text-cyber-gray">Punjab College</p>
                  </div>
              </div>
